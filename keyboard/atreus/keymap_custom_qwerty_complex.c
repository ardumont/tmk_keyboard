...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(SHIFT(KC_1) , SHIFT(KC_2)  , SHIFT(KC_LBRC), SHIFT(KC_RBRC), SHIFT(KC_BSLS)                   , SHIFT(KC_MINS) , KC_7        , KC_8         , KC_9         , SHIFT(KC_8), \
         ...
         KC_ESC      , KC_FN3       , KC_FN1        , KC_FN0        , KC_FN7          , KC_FN4, KC_FN4 , KC_FN7         , KC_FN0      , KC_DOT       , KC_0         , KC_ESC), \
  ...
  KEYMAP(CTRL(KC_Q)  , KC_CUT       , KC_END        , CTRL(KC_R)    , CTRL(KC_T)                       , KC_PASTE       , CTRL(KC_U)  , KC_TAB       , CTRL(KC_O)   , KC_UP, \
         KC_HOME     , CTRL(KC_S)   , KC_DELETE     , KC_RIGHT      , CTRL(KC_G)                       , KC_BSPC        , CTRL(KC_J)  , CTRL(KC_K)   , CTRL(KC_L)   , CTRL(KC_SCLN), \
         CTRL(KC_Z)  , CTRL(KC_X)   , CTRL(KC_C)    , CTRL(KC_V)    , KC_LEFT                          , KC_DOWN        , KC_ENT      , CTRL(KC_COMM), CTRL(KC_DOT) , KC_UNDO, \
         CTRL(KC_ESC), KC_NO        , KC_NO         , KC_FN0        , CTRL(KC_SPC)    , KC_FN4, KC_FN4 , CTRL(KC_LALT)  , KC_FN0      , CTRL(KC_MINS), CTRL(KC_QUOT), CTRL(KC_ESC))
};
...
const uint16_t PROGMEM fn_actions[] = {
  ...
  [5] = ACTION_MODS_TAP_KEY(MOD_LSFT, KC_Z), // z on tap, shift on pressed
  [6] = ACTION_MODS_TAP_KEY(MOD_LSFT, KC_SLSH), // / on tap, shift on pressed
