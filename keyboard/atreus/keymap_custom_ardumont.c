...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(SHIFT(KC_1), SHIFT(KC_2), SHIFT(KC_LBRC), SHIFT(KC_RBRC), SHIFT(KC_BSLS), \
         ...
         KC_FN4, SHIFT(KC_INS), KC_FN1, KC_LSFT, KC_LALT, KC_SPC, KC_SPC, \
         KC_LALT, KC_FN0, KC_DOT, KC_0, KC_FN4), \
  ...
  KEYMAP(CTRL(KC_Q), CTRL(KC_W), CTRL(KC_E), CTRL(KC_R), CTRL(KC_T), CTRL(KC_Y), CTRL(KC_U), KC_TAB, CTRL(KC_O), KC_UP, \
         ...
         KC_TRNS, CTRL(KC_TAB), CTRL(KC_ESC), CTRL(KC_LSFT), CTRL(KC_LALT), CTRL(KC_SPC), CTRL(KC_SPC), \
         CTRL(KC_LALT), CTRL(KC_FN0), CTRL(KC_MINS), CTRL(KC_QUOT), KC_TRNS)
};
