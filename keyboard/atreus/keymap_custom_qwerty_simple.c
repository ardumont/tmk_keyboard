...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, \
         ...
         KC_ESC, KC_FN3, KC_NO, KC_FN0, KC_FN8, KC_TAB, KC_ENT, KC_FN8, KC_FN0, KC_MINS, KC_QUOT, KC_ESC), \
  ...
  KEYMAP(SHIFT(KC_1), SHIFT(KC_2), SHIFT(KC_LBRC), SHIFT(KC_RBRC), SHIFT(KC_BSLS), KC_RBRC, KC_7, KC_8, KC_9, SHIFT(KC_8), \
         ...
         KC_ESC, SHIFT(KC_INS), KC_FN1, KC_FN0, KC_FN8, KC_TAB, KC_ENT, KC_FN8, KC_FN0, KC_DOT, KC_0, KC_ESC), \
  ...
  KEYMAP(KC_INS, KC_HOME, KC_UP, KC_END, KC_PGUP, KC_UP, KC_F7, KC_F8, KC_F9, KC_F10, \
         ...
         KC_FN3, KC_NO, KC_FN2, KC_FN2, KC_FN8, KC_TAB, KC_ENT, KC_FN8, KC_FN2, KC_NO, KC_NO, KC_FN3), \
};
